...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", type=str, default = "datasets/experiments/swap_retriever_same_generator/dev_gemma2_7b_it_faiss_rr.answers.txt")
    parser.add_argument("-t", type=str, default = "datasets/answers.dev.txt")
